...
from buscador_iryo  import buscar as buscar_iryo,  ruta_disponible as iryo_disponible, sesion_activa as iryo_activa, habilitado as iryo_habilitado
...
def procesar_ruta(config_ruta, fechas, config_global):
    ...
    # ── Iryo ────────────────────────────────────────────────
    if not iryo_habilitado():
        pass  # desactivado por IRYO_ENABLED=false. Silencio total.
    elif not iryo_disponible(destino):
